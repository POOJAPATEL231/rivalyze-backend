"""Refresh-token store — Postgres only.

Backed by the `refresh_tokens` table (schema.sql). No in-memory fallback: a
database must be configured or these calls raise.
